...
./neighborhood.exe ../../data/chien/outputGraphchienClean.txt $edges ./../data/chien/nodes_id.txt -o ../../results/${name}

awk '{print $1"\t"$2"\t"$4}' ../../results/chien/top1.txt > ../../results/chien/top1Clean.txt
python3 reads_to_align.py ../../results/chien/top1Clean.txt ../../results/chien/top1.fq 0
mkdir -p ${workDir}/../../results/${name}/processing/STAR_alignment
        STAR --genomeDir ${workDir}/../../results/${name}/genome \
            --runMode alignReads \
            --runThreadN 8 \
        ...
        bedtools intersect -wa -a ${TE} \
            ...
            > ${workDir}/../../results/${name}/intersectionTop1.txt
        python3 ${workDir}/suppDoublon.py ${workDir}/../../results/${name}/intersectionTop1.txt \
                    ${workDir}/../../results/${name}/intersectionTop1NoDouble.txt -t
"""