...
python3 analysis_comp.py ../../results/dog/processing/comp$i.fq ../../results/dog/processing/intersectionRef$i.txt ../../results/dog/processing/seq_intersectionCons$i.txt ../../results/dog/processing/cr_analysis$i.txt --custom-sep "split('\t')[8].split(';')[0][8:-1]" --short 
